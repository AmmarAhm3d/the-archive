...
// mpic++ hybrid_multiple_support_sendRecv.c -fopenmp -o hybrid_multiple_support_sendRecv && mpirun -np 4 ./hybrid_multiple_support_sendRecv && rm hybrid_multiple_support_sendRecv
// crux of the program is to show how to use MPI_Send and MPI_Recv functions
/*
