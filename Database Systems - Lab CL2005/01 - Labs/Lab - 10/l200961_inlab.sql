...
BEGIN
    ...
    BEGIN TRY
        ...
        IF @CGPA < 2.5
        BEGIN
            SET @ErrorMessage = 'Cannot register for course as CGPA is less than 2.5';
        ...
        INSERT INTO Registration (RollNumber, CourseID, GPA)
        VALUES (@StudentID, @CourseID, @CGPA);
...
EXEC RegisterStudent @StudentID =  '1', @CourseID =  '10', @CGPA =  '3.3';

-- already registered
EXEC RegisterStudent @StudentID =  '1', @CourseID =  '20', @CGPA =  '3.3';

-- cannot register
EXEC RegisterStudent @StudentID =  '1', @CourseID =  '30', @CGPA =  '1.0';